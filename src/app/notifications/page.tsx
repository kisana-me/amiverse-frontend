      ...
      <MainHeader>
        <div className="flex items-center justify-center w-full relative">
          ...
          <div className="absolute right-0">
            <Link prefetch={false} href="/settings/notifications" className="p-2 rounded-full settings-link-button" title="通知設定">
    ...
    <div className={`notification-item ${!checked ? "notification-unread" : ""}`}>
      ...
      <div className="notification-content">
        <div className="notification-header">
          {actor && (
            <Link prefetch={false} href={`/@${actor.name_id}`} className="actor-link">
        ...
        {post && (
          <Link prefetch={false} href={`/posts/${post.aid}`} className="notification-post-preview">
